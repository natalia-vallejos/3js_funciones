...
function canBuyProduct() {
    let producto1=1500;
    let cantidadqtengo=1150;
    let descuento= producto1 * 0.25;
    let preciofinal= producto1-descuento;
    let puedo= preciofinal<= cantidadqtengo;
    console.log(puedo ?"si puedes comprar el producto" : "no puedes comprar el producto");
}
